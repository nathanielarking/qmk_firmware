...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
      ...
      */
    [_MOUSE] = LAYOUT(
        _______,  _______,  _______,   _______,   _______,                              MS_BTN1,  MS_BTN4,  _______,  _______,   MS_ACL0,  
        _______,  _______,  _______,   _______,   _______,                              MS_BTN2,  MS_BTN5,  _______,  _______,   MS_ACL1,  
        _______,  _______,  _______,   _______,   _______,                              MS_BTN3,  MS_BTN6,  _______,  _______,   MS_ACL2,  
